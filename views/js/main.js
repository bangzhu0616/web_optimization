...
// minimize this file and rename to 'main.min.js'
...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    // add a variable 'randomPizzaContainers'
...
// move declaration of 'pizzasDiv' out the loop
...
function updatePositions() {
  ...
  // move some calcuation out of loop
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // We do not need 200 pizza, reduced the number to 50
  for (var i = 0; i < 50; i++) {
